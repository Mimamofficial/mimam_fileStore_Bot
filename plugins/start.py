...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('⚡️ ChillFliz | TV Shows', url='https://t.me/MRN_RIPPER'),
                    InlineKeyboardButton('🍁 MRN_RIPPER', url='https://t.me/+dt5i84djlh4wNGM1')
                ],
                [
                    InlineKeyboardButton('🍿.  ChillFliz | TV Shows  .🚀', url='https://t.me/+dt5i84djlh4wNGM1')
                ]
            ]
        )
